...
#------------------------------------------------------------------------------#
        ...
        for iter_f in range(opt.fusion_iter):
            ...
            triple_batch = triple_data.next_batch(opt.triple_batch_size, triple_type='hardest')
            ...
            # triplet loss
            anchor = triple_hf[0 : opt.triple_batch_size]
            pos = triple_hf[opt.triple_batch_size : opt.triple_batch_size*2]
            neg = triple_hf[opt.triple_batch_size*2 : opt.triple_batch_size*3] 
