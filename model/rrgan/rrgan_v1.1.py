...
#------------------------------------------------------------------------------#
        ...
        # training
        syn_att_input_v = netR(input_vf_v) #! CHANGE
        syn_att_gen_v = netR(gen_vf_v) #! CHANGE

        # attribute consistency loss
        input_r_loss = cos_criterion(syn_att_input_v, input_att_v)
        gen_r_loss = cos_criterion(syn_att_gen_v, input_att_v)
        R_cost = input_r_loss + gen_r_loss
        R_cost = R_cost.mean()
