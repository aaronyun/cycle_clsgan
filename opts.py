...
def parse():
    ...
    parser.add_argument('--nrh', type=int, default=1024, help='size of hidden units in R net when R has only one hidden layer')
    parser.add_argument('--nrh1', type=int, default=1024, help='size of the first layer in R net')
    parser.add_argument('--nrh2', type=int, default=521, help='size of the second layer in R net')
    ...
    parser.add_argument('--drop_rate', type=float, default=1, help='the rate of unit to drop in R net')

    # EXPERIMENT SPECIFICATION
    parser.add_argument('--bc', type=bool, default=False, help='whether use BC learning')
    parser.add_argument('--gzsl', action='store_true', default=False, help='enable generalized zero-shot learning')
    parser.add_argument('--critic_iter', type=int, default=5, help='crritic iteration, following WGAN-GP')
