...
class CLASSIFIER:
    # train_Y is interger 
    def __init__(self, netF,  _train_X, _train_Y, data_loader, _nclass, _cuda, _lr=0.001, _beta1=0.5, _nepoch=20, _batch_size=100, generalized=True):

        self.train_X =  _train_X 
        self.train_Y = _train_Y 

        # test seen data
        test_seen_hf = netF(Variable(data_loader.test_seen_feature.cuda())).cpu()
        self.test_seen_feature = test_seen_hf.data
        self.test_seen_label = data_loader.test_seen_label 
        self.seenclasses = data_loader.seenclasses

        # test unseen data
        test_unseen_hf = netF(Variable(data_loader.test_unseen_feature.cuda())).cpu()
        self.test_unseen_feature = test_unseen_hf.data
